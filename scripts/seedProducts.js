...
// This script adds sample products to the Firebase database for testing
...
const firebaseConfig = {
  ...
  // This should match the config in your firebase/firebase.js file
};
...
async function seedProducts() {
  try {
    ...
    for (let i = 0; i < sampleProducts.length; i++) {
      const product = {
        ...sampleProducts[i],
        // Add required fields that would normally be set by the system
        storeId: 'sample-store-id', // You may need to create a sample store first
        ownerId: 'sample-user-id', // You may need to use an actual user ID
