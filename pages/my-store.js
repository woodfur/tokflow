  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50 dark:from-neutral-900 dark:via-neutral-800 dark:to-neutral-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">Active Products</p>
                <p className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">
        ...
        {/* Tabs */}
        <div className="bg-white/70 dark:bg-neutral-800/70 backdrop-blur-sm rounded-3xl border border-neutral-200/50 dark:border-neutral-700/50 mb-8">
              ...
              <div>
                ...
                {products.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <button
                      onClick={() => router.push('/add-product')}
                      className="bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white px-6 py-3 rounded-2xl transition-all duration-200"
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    {products.map((product, index) => (
                      <motion.div
                        ...
                        className="bg-white/50 dark:bg-neutral-700/50 rounded-2xl border border-neutral-200/50 dark:border-neutral-600/50 overflow-hidden"
                      >
                        <div className="relative aspect-square">
                          ...
                          <div className="absolute top-2 right-2 flex space-x-1">
                            <button
                              ...
                              className="p-2 rounded-full backdrop-blur-sm bg-blue-500/90 text-white"
                              title="Edit Product"
                            >
                        ...
                        <div className="p-4">
                          <h4 className="font-semibold text-neutral-900 dark:text-neutral-100 mb-1 line-clamp-2">
                            {product.name}
                          </h4>
          ...
          >
            ...
            >
              ...
              <div className="flex space-x-3">
                <button
                  onClick={() => setShowDeleteModal(false)}
                  className="flex-1 py-2 px-4 bg-neutral-200 dark:bg-neutral-700 text-neutral-900 dark:text-neutral-100 rounded-xl hover:bg-neutral-300 dark:hover:bg-neutral-600 transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={isDeleting}
                  className="flex-1 py-2 px-4 bg-red-500 hover:bg-red-600 text-white rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
